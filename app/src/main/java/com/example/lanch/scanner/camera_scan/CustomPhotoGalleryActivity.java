...
public class CustomPhotoGalleryActivity extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Log.d("External_Content_URI", String.valueOf(MediaStore.Images.Media.EXTERNAL_CONTENT_URI));
        Log.d("Internal_Content_URI", String.valueOf(MediaStore.Images.Media.INTERNAL_CONTENT_URI));
